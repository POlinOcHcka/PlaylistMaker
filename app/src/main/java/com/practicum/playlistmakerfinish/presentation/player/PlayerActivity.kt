package com.practicum.playlistmakerfinish.presentation.player
...
import com.practicum.playlistmakerfinish.presentation.search.SEARCH_HISTORY_KEY
...
class PlayerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        track?.let {
            ...
            trackTime.text = SimpleDateFormat("mm:ss", Locale.getDefault()).format(it.timeMillis)
